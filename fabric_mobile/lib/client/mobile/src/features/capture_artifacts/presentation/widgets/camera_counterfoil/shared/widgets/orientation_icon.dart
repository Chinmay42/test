...
class OrientationWidgetCounterfoil extends StatefulWidget {
  final Widget child;
  final NativeDeviceOrientation orientation;

  const OrientationWidgetCounterfoil(
      {Key key, @required this.child, @required this.orientation})
      : super(key: key);
  @override
  _OrientationWidgetCounterfoilState createState() => _OrientationWidgetCounterfoilState();
}

class _OrientationWidgetCounterfoilState extends State<OrientationWidgetCounterfoil>
