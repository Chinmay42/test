...
class BlocCamera {
  ...
  Future getCameras() async {
    ...
    {
     //Toast.show('Camera ERROR',context,duration: Toast.LENGTH_LONG,gravity: Toast.BOTTOM);
     //Navigator.push(context,MaterialPageRoute(builder: (context) => FabricAppHomeScreen()));
